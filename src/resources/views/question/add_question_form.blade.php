...
<form action="/questions" method="POST" class="w-full max-w-[700px] flex flex-col gap-0 border-4 border-gray-800 rounded-2xl overflow-hidden brick-shadow bg-gray-800">
...
<input required name="title" class="form-input w-full rounded-xl text-[#181111] focus:ring-4 focus:ring-primary/20 border-2 border-gray-200 bg-gray-50 h-16 placeholder:text-[#896161] px-6 text-lg font-medium leading-normal" placeholder="What's on your mind? (e.g. How to build a tower?)" value=""/>
</label>
</div>
...
<textarea required name="content" class="form-input w-full rounded-xl text-[#181111] focus:ring-4 focus:ring-lego-blue/20 border-2 border-gray-200 bg-white min-h-[200px] placeholder:text-[#896161] p-6 text-lg font-medium leading-normal" placeholder="Describe your question in detail..."></textarea>
</label>
</div>
